	...
	)
{
	...
	VERIFY2(luabind::get_type(lua_result) != LUA_TNIL, make_string("cannot read number value %s", identifier));
	VERIFY2(luabind::get_type(lua_result) == LUA_TNUMBER, make_string("cannot read number value %s", identifier));
...
LPCSTR smart_cover::detail::parse_string(luabind::object const &table, LPCSTR identifier)
{
	...
	VERIFY2(luabind::get_type(result) != LUA_TNIL, make_string("cannot read string value %s", identifier));
	VERIFY2(luabind::get_type(result) == LUA_TSTRING, make_string("cannot read string value %s", identifier));
...
void smart_cover::detail::parse_table	(luabind::object const &table, LPCSTR identifier, luabind::object &result)
{
	...
	VERIFY2(luabind::get_type(result) != LUA_TNIL, make_string("cannot read table value %s", identifier));
	VERIFY2(luabind::get_type(result) == LUA_TTABLE, make_string("cannot read table value %s", identifier));
}
...
bool smart_cover::detail::parse_bool	(luabind::object const &table, LPCSTR identifier)
{
	VERIFY2(luabind::get_type(table) == LUA_TTABLE, "invalid loophole description passed");
	luabind::object	result = table[identifier];
	VERIFY2(luabind::get_type(result) != LUA_TNIL, make_string("cannot read boolean value %s", identifier));
	VERIFY2(luabind::get_type(result) == LUA_TBOOLEAN, make_string("cannot read boolean value %s", identifier));
...
int smart_cover::detail::parse_int		(luabind::object const &table, LPCSTR identifier)
{
	VERIFY2(luabind::get_type(table) == LUA_TTABLE, "invalid loophole description passed");
	luabind::object	result = table[identifier];
	VERIFY2(luabind::get_type(result) != LUA_TNIL, make_string("cannot read number value %s", identifier));
	VERIFY2(luabind::get_type(result) == LUA_TNUMBER, make_string("cannot read number value %s", identifier));
...
Fvector smart_cover::detail::parse_fvector (luabind::object const &table, LPCSTR identifier)
{
	VERIFY2(luabind::get_type(table) == LUA_TTABLE, "invalid loophole description passed");
	luabind::object	result = table[identifier];
	VERIFY2(luabind::get_type(result) != LUA_TNIL, make_string("cannot read vector value %s", identifier));
