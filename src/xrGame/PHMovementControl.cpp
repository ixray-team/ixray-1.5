...
//	return (IsGameTypeSingle()) ? ALife::eHitTypeStrike : ALife::eHitTypePhysicStrike;
}//
									  ...
									  Fvector &											out_deviation)
{
	...
	// TODO: Вернуть после синхронизаций
	...
	float const factor = 1;//jump_control->relative_time();
