...
void CWeapon::UpdateXForm	()
{
	...
	if (parent->inventory().GetActiveSlot() != GetSlot() && m_can_be_strapped_rifle /* &&
...
void CWeapon::reload			(LPCSTR section)
{
	...
	m_can_be_strapped_rifle = (/*BaseSlot() == INV_SLOT_2 ||*/ GetSlot() == RIFLE_SLOT);
	m_strapped_mode				= false;
	m_strapped_mode_rifle = false;
