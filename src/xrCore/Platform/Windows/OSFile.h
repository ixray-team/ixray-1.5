...
namespace Platform
{
    ...
    IC FileHandle CreateFile(const char* FilePath, bool SharedWrite)
    {
        ...
        auto FileSource = ::CreateFile(FilePath, FlagsLeft, FlagsRight, 0, OPEN_EXISTING, 0, 0);
    ...
    {
        auto Handle = ::CreateFile(FilePath, GENERIC_READ, FILE_SHARE_READ, 0, OPEN_EXISTING, 0, 0);
        return Handle;
    }
